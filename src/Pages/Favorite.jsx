            ...
            <div key={product.id} className="rounded-lg shadow-md p-4 space-y-4">
              ...
              <div className="flex justify-center gap-10">
                <Link to={`/product/${product.id}`}>
                  <button className='flex items-center w-full gap-4 bg-black shadow-md  text-white hover:bg-gray-300 hover:text-black duration-300 font-bold py-2 px-4 rounded '>
                  <FaSearch/>
