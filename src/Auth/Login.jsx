          ...
          <div>
            <form onSubmit={handleSubmit} className="w-full space-y-5">
              ...
              <div className="space-y-3">
                <button type="submit" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-5 rounded w-full">
                  Login
                </button>
                <div className='flex lg:flex-row flex-col justify-center gap-2'>
                  <p className="block text-center">Don't have an account?</p>
                  <Link to="/register"> 
                    <p className='text-blue-500 hover:underline hover:text-blue-700 text-center'>Register Now</p>
                  </Link>
                </div>
              </div>
            </form>
